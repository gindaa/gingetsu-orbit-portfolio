...
export const experiencesData = [
  ...
  },
  {
    ...
    shortDesc: "Spearheaded architectural modernization to Native (SwiftUI/Kotlin). Directed feature engineering pods enforcing Clean Architecture and MVVM standards.",
    responsibilities: [
      "Core Architecture & Strategy: Defined the foundational technical architecture for the Tring! by Pegadaian application. Conducted rigorous technical evaluations and secured stakeholder buy-in for a fully Native (SwiftUI/Kotlin) development strategy over Hybrid frameworks, guaranteeing superior runtime performance, security, and scalability.",
      "Feature Engineering Leadership: Directed a dedicated mobile engineering pod to architect and deliver the G-Cash financial feature, enforcing Clean Architecture and MVVM standards to ensure robust transaction handling and data integrity.",
      "Architectural Modernization: Spearheaded the end-to-end migration of Pegadaian Digital Syariah (Android: Java → Kotlin; iOS: UIKit → SwiftUI), significantly reducing technical debt and improving app responsiveness.",
